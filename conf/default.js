...
module.exports = {
	...
	admin: {
		...
		validEmails: ["aaron@clearlyinnovative.com"],
	...
	session: {
		...
		encryptionKey: 'GbmCqXR+71g/fJg3zfwJGNkz6Bd9npsXHI+tf9i5P3E=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'NKNsBMGNsYSTVfZTlhxDJ+EOSyXGc0MuTLTnyQegwyae8R7/qUn4il3NK/bvYVyFSyrzCLJ0kBmxNgMZzqbx6Q==',
		secret: 'fLjPly3HqEnOk9PZwTg/XpRVCs0CrCOr', // should be a large unguessable string
